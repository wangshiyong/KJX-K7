...
-(void)updateFrame {
    ...
    self.rightButton1.frame = CGRectMake(kWRScreenWidth - buttonWidth*2 - margin*2, top, buttonWidth, buttonHeight);
...
- (void)wr_setRightButton1Withtitle:(NSString *)title titleColor:(UIColor *)titleColor {
    [self wr_setRightButton1WithNormal:nil highlighted:nil title:title titleColor:titleColor];
}
